...
SWIFT_MODULE_NAMESPACE_PUSH("DigitalGate")
typedef SWIFT_ENUM(NSInteger, DGFlow) {
  DGFlowLogin = 0,
  DGFlowRegister = 1,
  DGFlowChange_user = 2,
};

typedef SWIFT_ENUM(NSInteger, DGLanguage) {
  DGLanguageTR = 0,
  DGLanguageEN = 1,
  DGLanguageDE = 2,
  DGLanguageBY = 3,
...
- (nonnull instancetype)init:(UIViewController * _Nonnull)rootViewController OBJC_DESIGNATED_INITIALIZER;
